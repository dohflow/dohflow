...
- **Priority discipline:** P0 = safety-critical or release-blocking; P1 = Week-8 first-playable foundation; P2 = MVP-1 manual/import functionality; P3 = MVP-2/3 features; P4 = release prep, polish, future bets. Avoid priority inversions (no higher-priority bead `blocks` on a lower-priority bead) — bump the blocker, defer the blocked, or rethink the dependency.
